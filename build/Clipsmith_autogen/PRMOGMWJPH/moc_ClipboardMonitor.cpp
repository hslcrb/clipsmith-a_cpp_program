/****************************************************************************
** Meta object code from reading C++ file 'ClipboardMonitor.hpp'
**
...
#include <memory>
#include "../../../src/core/ClipboardMonitor.hpp"
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ClipboardMonitor.hpp' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_ClipboardMonitor_t qt_meta_stringdata_ClipboardMonitor = {
    {
        ...
        QT_MOC_LITERAL(17, 14),  // "contentChanged"
        QT_MOC_LITERAL(32, 0),  // ""
...
void ClipboardMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->contentChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        {
            using _t = void (ClipboardMonitor::*)(const QString & );
            if (_t _q_method = &ClipboardMonitor::contentChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClipboardMonitor::contentChanged(const QString & _t1)
{
